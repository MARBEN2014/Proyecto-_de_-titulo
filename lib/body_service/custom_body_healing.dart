...
import 'package:paraflorseer/modals/map_healing.dart'; // Cambiado a map_healing
...
import 'package:paraflorseer/descripcions_servicios/descriptions_healing.dart'; // Cambiado a descriptions_healing
import 'package:paraflorseer/image_services/image_healing.dart'; // Cambiado a image_healing
        ...
        child: Column(
          ...
          children: [
            ...
            GridView.builder(
              ...
              itemCount:
                  descriptionsHealing.length, // Cambiado a descriptionsHealing
                    ...
                    children: [
                      Container(
                        ...
                        child: ClipRRect(
                          ...
                          child: imageHealing[index]
                                  .startsWith('http') // Cambiado a imageHealing
                              ? Image.network(
                                  imageHealing[index],
                                  fit: BoxFit.cover,
